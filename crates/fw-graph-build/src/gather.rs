...
use fw_graph_config::{GatherContext, Preset};
...
fn build_resource(
    class: &fw_graph_introspect::PgClass,
    introspection: &IntrospectionResult,
    ...
    let mut attrs: Vec<&fw_graph_introspect::PgAttribute> = introspection
        .attributes
        .iter()
    ...
    let class_constraints: Vec<&fw_graph_introspect::PgConstraint> = introspection
        .constraints
        .iter()
...
fn build_enums(
    ...
    for pg_type in &introspection.types {
        ...
        let mut labels: Vec<&fw_graph_introspect::PgEnum> = introspection
            .enums
            .iter()
