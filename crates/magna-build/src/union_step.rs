...
use magna_types::{FwGraphError, PgRow, StepFlags, StepId};
...
mod tests {
    use super::*;
    use async_trait::async_trait;
    use magna_core::{StepFingerprint, StepInputs, StepOutput};
    use magna_types::{PgValue, StepId};
    ...
    async fn test_union_step_tags_rows() {
        use magna_core::{Planner, optimize, Executor};
