//! Plugin trait for extending the fw-graph schema build process.
//!
...
///
/// This is a thin wrapper that will be extended once `fw-graph-introspect`
/// and `fw-graph-dataplan` types are integrated into this crate.
...
/// schema builder integration is added in `fw-graph-build`.
#[derive(Debug, Default)]
