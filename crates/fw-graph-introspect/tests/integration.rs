//! Integration tests for fw-graph-introspect.
//!
//! These tests require a running Postgres instance and are marked `#[ignore]`
//! by default. Run them with:
//!
//! ```sh
//! DATABASE_URL=postgres://... cargo test -p fw-graph-introspect -- --ignored
//! ```

use fw_graph_introspect::{introspect, IntrospectionCache};
use std::sync::Arc;
